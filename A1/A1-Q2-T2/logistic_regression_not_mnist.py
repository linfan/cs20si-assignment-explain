...
mnist = input_data.read_data_sets('/Users/flin/Documents/MachineLearning/Data/notMNIST/notMNIST-to-MNIST', one_hot=True)
...
w = tf.Variable(tf.zeros([784, 10]), name='weights')  # tf.random_normal(shape=[784, 10], stddev=0.01)

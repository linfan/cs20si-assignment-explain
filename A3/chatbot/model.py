...
class ChatBotModel(object):
    ...
    @staticmethod
    def _create_multi_rnn_cell():
        return tf.contrib.rnn.MultiRNNCell([tf.contrib.rnn.GRUCell(config.HIDDEN_SIZE)
    ...
    def _create_loss(self):
        ...
        def _seq2seq_f(encoder_inputs, decoder_inputs, do_decode):
            return tf.contrib.legacy_seq2seq.embedding_attention_seq2seq(
                encoder_inputs, decoder_inputs, self._create_multi_rnn_cell(),
